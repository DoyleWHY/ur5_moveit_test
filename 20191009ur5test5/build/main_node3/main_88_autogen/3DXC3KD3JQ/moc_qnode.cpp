...
#include "../../../../src/main_node3/ros_connect/qnode.h"
...
QT_MOC_LITERAL(1, 6, 21), // "signalShowAllPosition"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 21) // "signalSolveKinematics"

    },
    "QNode\0signalShowAllPosition\0\0"
    "signalSolveKinematics"
};
...
void QNode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalShowAllPosition(); break;
        case 1: _t->signalSolveKinematics(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNode::signalShowAllPosition)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QNode::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNode::signalSolveKinematics)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void QNode::signalShowAllPosition()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void QNode::signalSolveKinematics()
{
