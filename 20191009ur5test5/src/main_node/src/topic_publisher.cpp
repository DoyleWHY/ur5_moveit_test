...
#include "main_node/MsgTutorial.h" // MsgTutorial消息头文件（ 构建后自动生成）
int main(int argc, char **argv) // 节点主函数
{
    ...
    ros::Publisher ros_tutorial_pub =
            nh.advertise<main_node::MsgTutorial>("ros_tutorial_msg", 100);
    // 设定循环周期。"10"是指10Hz，是以0.1秒间隔重复
    ros::Rate loop_rate(10);
    main_node::MsgTutorial msg; // 以MsgTutorial消息文件格式声明一个 叫做msg的消息
